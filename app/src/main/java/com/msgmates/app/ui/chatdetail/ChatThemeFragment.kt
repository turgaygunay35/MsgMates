...
class ChatThemeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvTitle.text = getString(R.string.placeholder_title_chat_theme)
        binding.tvBody.text = "Sohbet teması ayarları sayfası yakında burada olacak."
    }
