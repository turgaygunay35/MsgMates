package com.msgmates.app.ui.webmsg
...
class WebmsgFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) { b.title.text = "WebMsgMates" }
